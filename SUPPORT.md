...
- **Works (or doesn't) on your Xcode, macOS or MCP client:**
  [send a compatibility report](https://github.com/AndrewKochulab/sim-mirror/issues/new?template=compatibility-report.yml)
  with `sim-mirror doctor --json`. Reports feed the compatibility matrix.
- **Security issues:** privately, as described in [SECURITY.md](SECURITY.md).

SimMirror is maintained in spare time, so replies can take a few days.
