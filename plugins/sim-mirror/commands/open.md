...
allowed-tools: Bash(uvx --from git+https://github.com/AndrewKochulab/sim-mirror@v0.1.0 sim-mirror open:*)
---
...
```
uvx --from git+https://github.com/AndrewKochulab/sim-mirror@v0.1.0 sim-mirror open
```
